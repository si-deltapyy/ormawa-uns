...
<div class="container">
    ...
    <div class="row justify-content-center gap-2">
        <div class="col-md col-sm">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="" action="{{route('admin.update', [$sample->id])}}" method="post"
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror"
                                        name="title" placeholder="{{$sample->nama_kegiatan}}" required>
                                    @error('title')
                            ...
                            <tr>
                                <td>NIM PIC</td>
                                <td><input type="text" class="form-control" name="nim" id=""
                                        placeholder="{{$sample->nim_pic}}" required></td>
                            </tr>
                            <tr>
                                <td>Kontak PIC</td>
                                <td><input type="text" class="form-control" name="kontak" id=""
                                        placeholder="{{$sample->kontak_pic}}" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Total Dana</td>
                                <td><input type="text" class="form-control" name="total_dana" id=""
                                        placeholder="{{$sample->jumlah_dana}}" required></td>
                            </tr>
                            <tr>
                                <td>Sumber Dana</td>
                                <td>
                                    <input type="checkbox" name="dana[]" class="form-check-inline"
                                        value="Dana RKAT UNS"> Dana RKAT UNS
                                    <br />
                                    ...
                                    <br />
                                    <input type="checkbox" name="dana[]" class="form-check-inline"
                                        value="Dana Registrasi Kegiatan"> Dana
