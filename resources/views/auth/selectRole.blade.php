...
<div class="container-fluid p-0">
    <div class="row g-0 login-wrapper">
        ...
        <div class="col-lg-4 d-none d-lg-block bg-login-image">
            <h1 class="display-4 fw-bold mb-3">Silahkan Ajukan <br>Role Anda</h1>
            <p class="lead mb-4 opacity-75">Ajuan akan diproses oleh admin MAWA UNS.</p>
            
            <div class="mt-4">
                <div class="d-flex align-items-center mb-3">
                    <i class="fas fa-check-circle me-3 fs-4"></i>
                    <span>Sebagai Pembina</span>
                </div>
                <div class="d-flex align-items-center mb-3">
                    <i class="fas fa-check-circle me-3 fs-4"></i>
                    <span>Sebagai Ketua</span>
                </div>
                <div class="d-flex align-items-center">
                    <i class="fas fa-check-circle me-3 fs-4"></i>
                    <span>Sebagai Anggota</span>
                </div>
            </div>
        </div>
            ...
            <div class="login-form-container">
                <div class="login-card">
                    <div class="text-center text-lg-start">
                        ...
                        <h2 class="fw-bold mb-1">Pilih Ajuan Role</h2>
                        <p class="text-muted mb-4">Silakan Pilih Role untuk mengelola data ormawa.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                   id="email" name="" placeholder="name@example.com" value="{{ Auth::user()->name }}" readonly>
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-control @error('role') is-invalid @enderror" id="role" name="role" required>
                                ...
                                <option value="ketua-ormawa">Ketua Ormawa</option>
