...
return [
    ...
    'idp' => [
        ...
        'singleSignOnService' => [
            ...
            // will be sent.
            'url' => env('SAML_IDP_SSO_URL', 'https://sso.uns.ac.id/saml2/idp/SSOService.php'),
            // SAML protocol binding to be used when returning the <Response>
            // message. OneLogin Toolkit supports the HTTP-Redirect binding
            // only for this endpoint.
            'binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
        ...
        'singleLogoutService' => [
            ...
            'url' => env('SAML_IDP_SLS_URL', 'https://sso.uns.ac.id/saml2/idp/SingleLogoutService.php'),
    ...
    'organization' => [
        'id-ID' => [
            ...
            'displayname' => 'Universitas Sebelas Maret',
            'url' => 'https://uns.ac.id',
        ],
    ],
